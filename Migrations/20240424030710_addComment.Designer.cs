...
namespace KLTN_E.Migrations
{
    ...
    [Migration("20240424030710_addComment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KLTN_E.Data.BanBe", b =>
                {
                    b.Property<int>("MaBb")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.ChiTietHd", b =>
                {
                    b.Property<int>("MaCt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.ChuDe", b =>
                {
                    b.Property<int>("MaCd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KLTN_E.Data.GopY", b =>
                {
            ...
            modelBuilder.Entity("KLTN_E.Data.HangHoa", b =>
                {
                    b.Property<int>("MaHh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.HoaDon", b =>
                {
                    b.Property<int>("MaHd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.HoiDap", b =>
                {
                    b.Property<int>("MaHd")
                        .HasColumnType("int")
                        .HasColumnName("MaHD");
            ...
            modelBuilder.Entity("KLTN_E.Data.KhachHang", b =>
                {
                    b.Property<string>("MaKh")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("KLTN_E.Data.Loai", b =>
                {
                    b.Property<int>("MaLoai")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KLTN_E.Data.NhaCungCap", b =>
                {
                    b.Property<string>("MaNcc")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("KLTN_E.Data.NhanVien", b =>
                {
                    b.Property<string>("MaNv")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("KLTN_E.Data.PhanCong", b =>
                {
                    b.Property<int>("MaPc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.PhanQuyen", b =>
                {
                    b.Property<int>("MaPq")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.PhongBan", b =>
                {
                    b.Property<string>("MaPb")
                        .HasMaxLength(7)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("KLTN_E.Data.Role", b =>
                {
            ...
            modelBuilder.Entity("KLTN_E.Data.TrangThai", b =>
                {
                    b.Property<int>("MaTrangThai")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KLTN_E.Data.TrangWeb", b =>
                {
                    b.Property<int>("MaTrang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KLTN_E.Data.VChiTietHoaDon", b =>
                {
                    b.Property<double>("DonGia")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("KLTN_E.Data.YeuThich", b =>
                {
                    b.Property<int>("MaYt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KLTN_E.Data.BanBe", b =>
                {
                    b.HasOne("KLTN_E.Data.HangHoa", "MaHhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaHh")
                    ...
                    b.HasOne("KLTN_E.Data.KhachHang", "MaKhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaKh")
            ...
            modelBuilder.Entity("KLTN_E.Data.ChiTietHd", b =>
                {
                    b.HasOne("KLTN_E.Data.HoaDon", "MaHdNavigation")
                        .WithMany("ChiTietHds")
                        .HasForeignKey("MaHd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("KLTN_E.Data.ChuDe", b =>
                {
                    b.HasOne("KLTN_E.Data.NhanVien", "MaNvNavigation")
                        .WithMany("ChuDes")
                        .HasForeignKey("MaNv")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("KLTN_E.Data.Comment", b =>
                {
                    b.HasOne("KLTN_E.Data.HangHoa", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KLTN_E.Data.KhachHang", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("KLTN_E.Data.GopY", b =>
                {
                    b.HasOne("KLTN_E.Data.ChuDe", "MaCdNavigation")
                        .WithMany("Gopies")
                        .HasForeignKey("MaCd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("KLTN_E.Data.HangHoa", b =>
                {
                    b.HasOne("KLTN_E.Data.Loai", "MaLoaiNavigation")
                        .WithMany("HangHoas")
                    ...
                    b.HasOne("KLTN_E.Data.NhaCungCap", "MaNccNavigation")
                        .WithMany("HangHoas")
                        .HasForeignKey("MaNcc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("KLTN_E.Data.HoaDon", b =>
                {
                    ...
                    b.HasOne("KLTN_E.Data.TrangThai", "MaTrangThaiNavigation")
                        .WithMany("HoaDons")
            ...
            modelBuilder.Entity("KLTN_E.Data.KhachHang", b =>
                {
                    b.HasOne("KLTN_E.Data.Role", "VaiTroNavigation")
                        .WithMany("KhachHangs")
            ...
            modelBuilder.Entity("KLTN_E.Data.PhanCong", b =>
                {
                    ...
                    b.HasOne("KLTN_E.Data.PhongBan", "MaPbNavigation")
                        .WithMany("PhanCongs")
                        .HasForeignKey("MaPb")
                        .IsRequired()
            ...
            modelBuilder.Entity("KLTN_E.Data.PhanQuyen", b =>
                {
                    ...
                    b.HasOne("KLTN_E.Data.TrangWeb", "MaTrangNavigation")
                        .WithMany("PhanQuyens")
